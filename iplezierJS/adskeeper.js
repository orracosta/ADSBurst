...
function setClick(){
    setCookie("_zkx2_delay_time",  "1", 4);
...
function h12_revertDiv() {
    h12_canTrack = 0;
    $("#" + h12_div).css("z-index", "-90000").css("bottom", "0").css("left", "0").css("position", "fixed").css("width", "").css("pointer-events", "none").css("opacity", "0.0001");
}
function h12_startScript(){
    ...
    if(getCookie("_zkx2_delay_time") == null && getCookie("_zkx1_delay_time") != null){
